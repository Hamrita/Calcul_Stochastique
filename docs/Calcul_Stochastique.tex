...
\includegraphics{Calcul_Stochastique_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\protect\hypertarget{thm:unnamed-chunk-50}{}{\label{thm:unnamed-chunk-50} \iffalse (Equations de Chapman-Kolmogorov) \fi{} }Pour tout \$(i, j) \in E\^{}2 et tout couple \((m, n)\) d'entiers positifs, on a l'identité :
\[
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-51}{}{\label{exm:unnamed-chunk-51} }Soit une CM définie par la matrice de transition \[
  P=\left( 
  \begin{array}{cccc}
  0.2 & 0.4 & 0.1 & 0.3\\
  0 & 0.5 & 0.4 & 0.1\\
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-58}{}{\label{def:unnamed-chunk-58} }On dit que l'état \(j\) est \(\color{blue}{\mathbf{\text{accessible}}}\) à partir de l'état \(i\), s'il existe un entier \(n \geq 0\) tel que \(P^{(n)}_{ij} >0\). On note \(i \longrightarrow j\).
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-59}{}{\label{def:unnamed-chunk-59} }Les états \(i\) et \(j\) sont dans la même classe communicante si \(i \longleftrightarrow j\).
\end{definition}

\begin{example}
\protect\hypertarget{exm:unnamed-chunk-60}{}{\label{exm:unnamed-chunk-60} }Trouvez les classes communicantes associées au diagramme de transition suivant.
\end{example}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-62}{}{\label{def:unnamed-chunk-62} }Une classe d'états communicante est fermée s'il est impossible de quitter
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-63}{}{\label{def:unnamed-chunk-63} }Si la chaîne de Markov ne possède qu'une unique classe, c'est à dire que tous
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-64}{}{\label{exm:unnamed-chunk-64} }On considère la CMD à tois états 1, 2, 3 et de matrice stochastique
\[
  P=\left( 
    \begin{array}{ccc}
    1/2 & 1/2 & 0 \\
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-65}{}{\label{exm:unnamed-chunk-65} }Soit la CMD à quatre états définie par la matrice stochastique
\[
  P=\left( 
    \begin{array}{cccc}
    1/2 & 1/2 & 0 &0\\
...
\begin{theorem}
\protect\hypertarget{thm:unnamed-chunk-69}{}{\label{thm:unnamed-chunk-69} }Le vecteur des temps moyens d'atteinte de \(A\), à partir de \(i\), \(\mathbf{m}_A=(m_{iA}, i \in E)\) est la solution minimale non négative du système suivant:
\[
m_{iA}=\left\{
\begin{array}{ll}
0 & \text{ si } i \in A\\
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-70}{}{\label{exm:unnamed-chunk-70} }On considère la chaîne suivante
\end{example}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-72}{}{\label{def:unnamed-chunk-72} }Une distribution de probabilité \(\pi\) satisfaisant l'équation de balance globale \(\pi =\pi P\) est appelée \textbf{distribution stationnaire} de la matrice de transition \(P\), ou de la chaîne de Markov avec \(\pi_j \geq 0\) et \(\sum \pi_j=1\).

La distribution \(\pi\) est appelée aussi distribution invariante ou aussi distribution d'équilibre.
\end{definition}

\begin{example}
\protect\hypertarget{exm:unnamed-chunk-73}{}{\label{exm:unnamed-chunk-73} }Soit \(P=\left(\begin{array}{ccc}  0 & 1 & 0 \\ 0 & \frac{1}{2} & \frac{1}{2}\\ \frac{1}{2} & 0 & \frac{1}{2}  \end{array}\right)\)
...
\(P'V=V \Longleftrightarrow \left\{ \begin{array}{l} \frac{1}{2}z=x\\ x+\frac{1}{2}y=y\\ \frac{1}{2}y + \frac{1}{2}z =z \end{array} \right. \Longleftrightarrow \left\{ \begin{array}{l} x=z\\ y=z\\ z \in \mathbb{R} \end{array} \right.\)
