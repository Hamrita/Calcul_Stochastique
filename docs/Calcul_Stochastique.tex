...
\]
Sous R, on peut déterminer et évaluer les fonctions génératrices des moments en utilisant l'extension \texttt{MGF} qui est téléchargeable depuis l'adresse suivante: \url{https://github.com/alexandernel14/MGF}.

Une description de l'installation et l'utilisation de cette extension est donnée dans cette capsule video:

\url{https://www.youtube.com/watch?v=2CaRpHh__6I}
