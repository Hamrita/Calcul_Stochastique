...
\end{example}
\includegraphics{Calcul_Stochastique_files/figure-latex/unnamed-chunk-46-1.pdf}
...
\includegraphics{Calcul_Stochastique_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\protect\hypertarget{thm:unnamed-chunk-51}{}{\label{thm:unnamed-chunk-51} \iffalse (Equations de Chapman-Kolmogorov) \fi{} }Pour tout \$(i, j) \in E\^{}2 et tout couple \((m, n)\) d'entiers positifs, on a l'identité :
\[
